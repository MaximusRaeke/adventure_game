...
let heroName = prompt("Please enter your name", "");
let state = {}
...
const textNodes = [
  {
    id: 0,
    text: heroName + ', welcome to Brandon\'s Adventure Game! Be on your guard as treachery and danger lie ahead for you Adventurer!',
    options: [
      {
        text: 'Venture Forth',
        nextText: 1
